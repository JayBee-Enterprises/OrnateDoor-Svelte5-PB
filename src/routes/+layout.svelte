...
<div class="min-h-screen bg-base-100 text-base-content">
        ...
        <div class="navbar bg-base-200 shadow-md">
            <div class="navbar-start">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                        <li><a href="#mtg-tools">MTG Tools</a></li>
                        <li><a href="#dnd-tools">D&D Tools</a></li>
                        <li><a href="#dnd-kb">D&D Knowledge Base</a></li>
                    </ul>
                </div>
            ...
            <div class="navbar-center hidden lg:flex">
                <ul class="menu menu-horizontal px-1">
                    <li><a href="#mtg-tools">Magic: The Gathering Tools</a></li>
                    <li><a href="#dnd-tools">Dungeons & Dragons Tools</a></li>
                    <li><a href="#dnd-kb">D&D Knowledge Base</a></li>
                </ul>
            </div>
	...
	<!-- Footer -->
        ...
        <aside>
            <p>© {new Date().getFullYear()} Ornate Door Games - All right reserved</p>
        </aside>
    </footer>
</div>
